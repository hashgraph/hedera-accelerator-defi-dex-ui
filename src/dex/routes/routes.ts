...
/**
 * This is a temporary copy of the DAO routes. Importing routes
 * from the `@dao/routes` alias resulted in build errors.
 * TODO: Move all DAO code under the `/dao` folder.
 * */

...
import { Wizard } from "@dex/components";
...
export function CreateDAOProposal() {
  ...
  const backTo = `/${currentDaoType}/${daoAccountId}/${DAORoutes.Overview}`;
  ...
  const tokenTransferGovernorAccountId = governors?.tokenTransferLogic
    ...
    : "";
  const transferFrom = currentDaoType === DAORoutes.Multisig ? safeAccountId : tokenTransferGovernorAccountId;
  const wizardTitle = currentWizardStep === "type" ? "New Proposal" : type;
  const accountTokenBalancesQueryResults = useAccountTokenBalances(
    currentDaoType === DAORoutes.Multisig ? safeAccountId : daoAccountId
  );
  ...
  const steps = [
    {
      label: "Type",
      route: `/${currentDaoType}/${daoAccountId}/${DAORoutes.CreateDAOProposal}/${DAORoutes.DAOProposalType}`,
  ...
  function handleCreateDAOProposalSuccess(transactionResponse: TransactionResponse) {
    ...
    const pathTo = `/${currentDaoType}/${daoAccountId}/${DAORoutes.Overview}`;
  ...
  function ProposalsDetailsForm(): string {
    switch (type) {
      case DAOProposalType.Text:
        return `/${currentDaoType}/${daoAccountId}/${DAORoutes.CreateDAOProposal}/${DAORoutes.DAOTextProposalDetails}`;
      case DAOProposalType.TokenTransfer:
        return `/${currentDaoType}/${daoAccountId}/${DAORoutes.CreateDAOProposal}/${DAORoutes.DAOTokenTransferDetails}`;
      case DAOProposalType.AddMember:
        return `/${currentDaoType}/${daoAccountId}/${DAORoutes.CreateDAOProposal}/${DAORoutes.DAOAddMemberDetails}`;
      case DAOProposalType.RemoveMember:
        return `/${currentDaoType}/${daoAccountId}/${DAORoutes.CreateDAOProposal}/${DAORoutes.DAODeleteMemberDetails}`;
      case DAOProposalType.ReplaceMember:
        return `/${currentDaoType}/${daoAccountId}/${DAORoutes.CreateDAOProposal}/${DAORoutes.DAOReplaceMemberDetails}`;
      case DAOProposalType.UpgradeThreshold:
        return `/${currentDaoType}/${daoAccountId}/`.concat(
          `${DAORoutes.CreateDAOProposal}/${DAORoutes.DAOUpgradeThresholdDetails}`
        );
      case DAOProposalType.ContractUpgrade:
        return `/${currentDaoType}/${daoAccountId}/`.concat(
          `${DAORoutes.CreateDAOProposal}/${DAORoutes.DAOContractUpgradeDetails}`
        );
      case DAOProposalType.TokenAssociate:
        return `/${currentDaoType}/${daoAccountId}/`.concat(
          `${DAORoutes.CreateDAOProposal}/${DAORoutes.DAOTokenAssociateDetails}`
        );
      default:
        return "";
    }
  ...
  function ProposalsReviewForm(): string {
    switch (type) {
      case DAOProposalType.Text:
        return `/${currentDaoType}/${daoAccountId}/${DAORoutes.CreateDAOProposal}/${DAORoutes.DAOTextProposalReview}`;
      case DAOProposalType.TokenTransfer:
        return `/${currentDaoType}/${daoAccountId}/${DAORoutes.CreateDAOProposal}/${DAORoutes.DAOTokenTransferReview}`;
      case DAOProposalType.AddMember:
        return `/${currentDaoType}/${daoAccountId}/${DAORoutes.CreateDAOProposal}/${DAORoutes.DAOAddMemberReview}`;
      case DAOProposalType.RemoveMember:
        return `/${currentDaoType}/${daoAccountId}/${DAORoutes.CreateDAOProposal}/${DAORoutes.DAODeleteMemberReview}`;
      case DAOProposalType.ReplaceMember:
        return `/${currentDaoType}/${daoAccountId}/${DAORoutes.CreateDAOProposal}/${DAORoutes.DAOReplaceMemberReview}`;
      case DAOProposalType.UpgradeThreshold:
        return `/${currentDaoType}/${daoAccountId}/`.concat(
          `${DAORoutes.CreateDAOProposal}/${DAORoutes.DAOUpgradeThresholdReview}`
        );
      case DAOProposalType.ContractUpgrade:
        return `/${currentDaoType}/${daoAccountId}/`.concat(
          `${DAORoutes.CreateDAOProposal}/${DAORoutes.DAOContractUpgradeReview}`
        );
      case DAOProposalType.TokenAssociate:
        return `/${currentDaoType}/${daoAccountId}/${DAORoutes.CreateDAOProposal}/${DAORoutes.DAOTokenAssociateReview}`;
      default:
        return "";
    }
  }
  ...
  async function ValidateDetailsForm(): Promise<boolean> {
    switch (type) {
      case DAOProposalType.Text:
        return currentDaoType === DAORoutes.NFT
      ...
      case DAOProposalType.TokenTransfer: {
        return currentDaoType === DAORoutes.Multisig

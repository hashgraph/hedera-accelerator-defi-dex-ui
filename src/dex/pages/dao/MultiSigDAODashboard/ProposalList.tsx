...
import { Proposal, ProposalStatus, useDAOProposals, useGovernanceDAOProposals, useTabFilters } from "@dex/hooks";
import { useLocation, useNavigate, useOutletContext } from "react-router-dom";
import { ProposalCard } from "../ProposalCard";
import { Flex } from "@chakra-ui/react";
import { DAODetailsContext, GovernanceDAODetails, MultiSigDAODetails } from "@dex/services";
...
export function ProposalList() {
  ...
  function handleClickCreateProposal() {
    navigate(replaceLastRoute(location.pathname, DAORoutes.CreateDAOProposal));
  }

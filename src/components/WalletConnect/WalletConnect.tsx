    ...
    return (
        <>
            <Button
                ...
                {walletConnectState.connectionStatus === WalletConnectionStatus.READY_TO_PAIR ? 'Connect to a Wallet' :
                    walletConnectState.connectionStatus === WalletConnectionStatus.INITIALIZING ? 'Waiting to Connect' :
